...
substance in moles, R is the ideal gas constant, equal to 8.314 , and T is the
...
pressure = float(input("Enter the pressure in Pascal: "))
volume = float(input("Enter the volume in liters: "))
temperature = float(input("Enter the temperature in Celsius: "))

amount_of_substance = (pressure * volume)/(IDEAL_GAS_CONSTANT * (temperature + 273.15))

print(f"The amount of gas in moles is {amount_of_substance:.3f}")
